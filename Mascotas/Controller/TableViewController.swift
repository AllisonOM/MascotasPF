...
class TableViewController: UITableViewController {
    ...
    func actualizar() {
        ...
        switch filtro.selectedSegmentIndex {
            ...
            case 3: // TODO: - Crea el método necesario
                let pericos = DataManager.shared.todasLasMascotas(tipo: "perico")
                let canarios = DataManager.shared.todasLasMascotas(tipo: "canario")
                mascotas = pericos + canarios
            case 4:mascotas = DataManager.shared.mascotasOtros() // TODO: - Crea el método necesario
